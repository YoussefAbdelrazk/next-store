                ...
                <Card className='transform group-hover:shadow-xl transition-shadow duration-500'>
                  <CardContent className="p-4">
                    <div className="relative h-64 md:48 rounded overflow-hidden">
                      <Image src={image} alt={name} fill sizes='(max-width:768px) 100vw,(max-width:1200px) 50vw, 33vw ' priority className="rounded w-full object-cover transform group-hover-scale-110 transtion-transform duration-500"/>
